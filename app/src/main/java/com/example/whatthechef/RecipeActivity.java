            ...
            public void onResponse(JSONArray response) {
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        listItem.setItemImage(jsonObject.getString("title").toString());
                        listItem.setItemDescription(jsonObject.getString("description").toString());
                        listItem.setItemImage(jsonObject.getString("image").toString());
                        items.add(listItem);
